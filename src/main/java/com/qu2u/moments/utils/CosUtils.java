package com.qu2u.moments.utils;
...
public class CosUtils {
    ...
    //腾讯云的SecretId
    @Value("${COS.secretId}")
    private static String secretId = "AKIDQs9XqGbyGKbkldJK9k8IyifWG6vfNwR5";

    //腾讯云的SecretKey
    @Value("${COS.secretKey}")
    private static String secretKey = "sBMLGhx2xgLtHSTbfV7AC6laIxUtdIm9";

    //腾讯云的bucket (存储桶)
    @Value("${COS.bucket}")
    private static String bucket = "gallerys-1305976148";
    ...
    //腾讯云的访问基础链接:
    @Value("${COS.url}")
    private static String baseUrl = "https://gallerys-1305976148.cos.ap-guangzhou.myqcloud.com/";
